<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="view_nobat.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 387px; text-align: right; margin-right: 71px;">
        ...
        <tr>
            <td style="width: 224px">
                <asp:Button ID="Button2" runat="server" Font-Size="Small" Text="انصراف" 
                    onclick="Button1_Click" />
            </td>
            <td style="width: 132px">
                <asp:Button ID="Button1" runat="server" Font-Size="Small" Text="تایید نوبت" 
